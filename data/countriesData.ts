...
export const countriesData: Country[] = [
  ...
  { name: 'Slovenia', code: 'SI', visited: true, continent: 'Europe' },
  { name: 'Croatia', code: 'HR', visited: true, continent: 'Europe' },
  { name: 'Hungary', code: 'HU', visited: true, continent: 'Europe' },
  { name: 'Poland', code: 'PL', visited: false, continent: 'Europe' },
  { name: 'Denmark', code: 'DK', visited: false, continent: 'Europe' },
  { name: 'Sweden', code: 'SE', visited: false, continent: 'Europe' },
  ...
  { name: 'Romania', code: 'RO', visited: false, continent: 'Europe' },
  { name: 'Bulgaria', code: 'BG', visited: false, continent: 'Europe' },
  { name: 'Serbia', code: 'RS', visited: false, continent: 'Europe' },
  ...
  { name: 'Greece', code: 'GR', visited: false, continent: 'Europe' },
  { name: 'Portugal', code: 'PT', visited: false, continent: 'Europe' },
  ...
  { name: 'Vatican City', code: 'VA', visited: false, continent: 'Europe' },
  ...
  { name: 'South Korea', code: 'KR', visited: false, continent: 'Asia' },
  ...
  { name: 'Thailand', code: 'TH', visited: false, continent: 'Asia' },
  ...
  { name: 'Malaysia', code: 'MY', visited: false, continent: 'Asia' },
  { name: 'Singapore', code: 'SG', visited: false, continent: 'Asia' },
  ...
  { name: 'Turkey', code: 'TR', visited: false, continent: 'Asia' },
  ...
  { name: 'Israel', code: 'IL', visited: false, continent: 'Asia' },
  ...
  { name: 'Tanzania', code: 'TZ', visited: false, continent: 'Africa' },
